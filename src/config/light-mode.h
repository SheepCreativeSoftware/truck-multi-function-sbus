...
enum CombinedLightStates: uint32_t {
  ...
  COMB_US_TAIL_L = (BIT_PARKING_LIGHT | BIT_BRAKE_LIGHT | BIT_HAZARD_LIGHT | BIT_TURN_SIGNAL_L),
  COMB_US_TAIL_R = (BIT_PARKING_LIGHT | BIT_BRAKE_LIGHT | BIT_HAZARD_LIGHT | BIT_TURN_SIGNAL_R),
  COMB_PARK_TURN_L = (BIT_PARKING_LIGHT | BIT_HAZARD_LIGHT | BIT_TURN_SIGNAL_L),
  COMB_PARK_TURN_R = (BIT_PARKING_LIGHT | BIT_HAZARD_LIGHT | BIT_TURN_SIGNAL_R),
};
